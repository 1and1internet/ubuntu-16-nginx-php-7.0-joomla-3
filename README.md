# Joomla 3 on Nginx with PHP 7.0 on Ubuntu 16.04 LTS (Xenial Xerus)
...
docker run -u ${UID}:0 -p ${PORT}:8080 -v ${WEB_ROOT}:/var/www/ 1and1internet/ubuntu-16-nginx-php-7.0-joomla-3
```
